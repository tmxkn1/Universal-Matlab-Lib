function r = rotx(varargin)
%ROTX rotation matrix about x-axis
% 
% R = rotx(A) returns R representing the rotation about the x-axis by angle
% A in radians.
%
% R = rotx(A,'Degree') returns R representing the rotation about the x-axis
